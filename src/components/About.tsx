...
const About: React.FC<AboutProps> = ({ dark = true, title = "Place Holder", text = ["Place Holder Text", "More text"], aboutTitle, aboutSkills }) => {
    return (
      <section id="about" className={` w-full ${dark ? "bg-dark-theme-dark" : "bg-light-theme-dark"}`}>
        <div className="flex  flex-col justify-center gap-4 h-full lg:flex-row" style={{ paddingTop: "130px" }}>
          <div className={`w-full lg:w-1/2 border-2 lg:ml-4`}>
          ...
          <div className="w-full lg:w-1/2 h-full lg:mr-4 border-2 pb-8">
            ...
            <div className="h-full flex flex-wrap items-center justify-center gap-4 flex-grow mt-8">
              {aboutSkills.map((skill, i) => (
                <div
                  ...
                  style={{ minWidth: "140px", minHeight: "140px" }} // Set minimum dimensions
                  key={`skill_key_${i}`}
                >
